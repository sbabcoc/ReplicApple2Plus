...
final class ExpansionRomArbiter {
    ...
    /**
     * Dispatches an access to $C800-$CFFF. {@code value == -1} means a
     * read; any other value is the byte to write. {@code address} is the
     * absolute CPU address, needed to detect exactly $CFFF.
     */
    int access(int address, int value) {
