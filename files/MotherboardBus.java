 ...
 * and $D000-$FFFF (language card banking over the system ROM) -- is
 * registered as a {@link NotYetImplementedHandler}, naming the specific
 * missing subsystem. Building the real one later means changing exactly
 * one registration line here; nothing about {@link AddressSpace}, the
 * CPU, or any other region's handler needs to change at all.
 */
public final class MotherboardBus implements MemoryBus {
    ...
    public MotherboardBus(SlotCard[] slots) {
        ...
        addressSpace.register(0xC050, 0xC05F, new NotYetImplementedHandler(VIDEO_GAP));
